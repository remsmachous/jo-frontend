 ...
 * Généré: 2025-09-06T17:08:28.997Z
 */
...
export const offresSolo = [
  ...
  { image: "https://jobackend.fly.dev/media/offres/skateboard.jpeg", alt: "Affiche des JO de Paris 2024 pour le skateboard, représentant un athlète réalisant une figure devant la Tour Eiffel.", titre: "Pack Solo: Skateboard", description: "1 billet pour les qualifications de Skateboard Park à la Concorde.", prix: 80, btnLabel: "Réserver ma place", btnClass: BTN_CLASS, btnHref: "/reservation" }
];

export const offresDuo = [
  { image: "https://jobackend.fly.dev/media/offres/bmx.jpg", alt: "Affiche des JO de Paris 2024 illustrant les sports urbains, avec des athlètes de BMX et de skateboard au-dessus des toits de Paris.", titre: "Pack Duo: BMX Freestyle", description: "2 places pour les qualifications de BMX Freestyle au cœur de Paris.", prix: 120, btnLabel: "Pack Duo: BMX Freestyle", btnClass: BTN_CLASS, btnHref: "/reservation" },
  { image: "https://jobackend.fly.dev/media/offres/judo.jpg", alt: "Affiche des JO de Paris 2024 pour le judo, représentant deux judokas se saluant respectueusement devant la Tour Eiffel.", titre: "Pack Duo: Judo", description: "2 billets pour les phases éliminatoires de Judo à l'Arena Champ-de-Mars.", prix: 150, btnLabel: "Pack Duo: Judo", btnClass: BTN_CLASS, btnHref: "/reservation" },
  { image: "https://jobackend.fly.dev/media/offres/tennis.webp", alt: "Affiche des JO de Paris 2024 pour le tennis, vue plongeante d'un joueur en action sur un court en terre battue.", titre: "Pack Duo: Tennis", description: "2 places pour un match sur la terre battue mythique de Roland-Garros.", prix: 160, btnLabel: "Pack Duo: Tennis", btnClass: BTN_CLASS, btnHref: "/reservation" }
];

export const offresFamille = [
  { image: "https://jobackend.fly.dev/media/offres/natation.jpeg", alt: "Affiche des JO de Paris 2024 pour la natation, avec un nageur en pleine action dans un couloir de piscine.", titre: "Pack Famille: Natation", description: "4 places (2 adultes + 2 enfants) pour les séries de natation à La Défense Arena.", prix: 250, btnLabel: "Pack Famille: Natation", btnClass: BTN_CLASS, btnHref: "/reservation" },
  { image: "https://jobackend.fly.dev/media/offres/handball.jpg", alt: "Affiche des JO de Paris 2024 pour le handball, montrant un joueur en plein saut, s'apprêtant à tirer.", titre: "Pack Famille: Handball", description: "4 places pour un match de l'équipe de France de handball au stade Pierre-Mauroy.", prix: 240, btnLabel: "Pack Famille: Handball", btnClass: BTN_CLASS, btnHref: "/reservation" },
  { image: "https://jobackend.fly.dev/media/offres/equitation.jpg", alt: "ffiche des JO de Paris 2024 pour les sports équestres, avec un cavalier et sa monture devant le Château de Versailles.", titre: "Pack Famille: Sports Équestres", description: "4 places pour l'épreuve de saut d'obstacles par équipe dans le cadre royal de Versailles.", prix: 295, btnLabel: "Pack Famille: Sports Équestres", btnClass: BTN_CLASS, btnHref: "/reservation" }
];
